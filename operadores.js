...
// numero += 3; // soma 3 ao valor que ja estiver na variável
// console.log("somei 3: " , numero);
// numero -= 2; // subtrai 2 ao valor que tem na variável 
// console.log("subtrai 2: " , numero);
// numero *=4; // multiplica por 4 o que já tem na variável
// console.log("multipliquei por 4: " , numero);
// numero /=2; // divide por 2 o que estiver na variável
